import { ZodArrayDef, ZodNonEmptyArray, ZodNonEmptyArrayDef, ZodTypeDef } from 'zod'
...
export function parseNonEmptyArrayDef(def: ZodArrayDef | ZodNonEmptyArrayDef, path: string[], visited: { def: ZodTypeDef; path: string[] }[]) {
  {
    const res: JsonSchema7ArrayType = {
      type: 'array',
      items: parseDef(def.type, [...path, 'array'], visited),
